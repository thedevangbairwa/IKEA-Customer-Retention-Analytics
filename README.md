...
│   └── IKEA\_Customer\_Retention\_Project.pdf

├── PowerBI/

│   └── IKEA\_Customer\_Retention.pbix

├── Data/

│   ├── Customer\_Demographics.csv

│   ├── Customer\_Transactions.csv

│   ├── Churn\_Labelled\_Customers.csv

│   ├── Loyalty\_Program.csv

│   └── Store\_Locations.csv

└── Screenshots/

├── 1\_Overview.png

├── 2\_Promotions\_Loyalty.png

├── 3\_Store\_Performance.png

├── 4\_Customer\_Value.png

└── Final\_Recommendations\_Insights.png
